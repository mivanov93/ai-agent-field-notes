...
| 10 | [The model votes for more rules](10-the-model-votes-for-more-rules.md) | Ask the model how to fix the model and it recommends what doesn't work: gate me harder, trim your rules, every codebase looks like this, clean from now on. No malice — its self-claims are retrieved memes, not introspection. Demand measurements and refutations, not advice. |
